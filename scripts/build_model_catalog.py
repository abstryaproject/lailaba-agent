#!/usr/bin/env python3
"""Build the Lailaba Model Catalog — a centralized JSON manifest of curated models.
...
Lailaba CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Lailaba release.
...
# Ensure LAILABA_HOME is set for imports that touch it at module level.
os.environ.setdefault("LAILABA_HOME", os.path.join(os.path.expanduser("~"), ".lailaba"))

from lailaba_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "lailaba-agent repo",
            "docs": "https://lailaba-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
