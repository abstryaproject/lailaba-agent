...
DEFAULT_DATASETS = [
    ...
    "NousResearch/lailaba-agent-megascience-sft1",
    "NousResearch/Lailaba-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Lailaba-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-lailaba-agent"
]
