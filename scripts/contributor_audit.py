...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Lailaba\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "lailaba@nousresearch.com",
    "lailaba-audit@example.com",
    "lailaba@habibilabs.dev",
    "omx@oh-my-codex.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/lailaba-agent",
                "--state", "merged",
