#!/usr/bin/env python3
"""Build the Lailaba Skills Index — a centralized JSON catalog of all skills.
...
`lailaba skills search/install` can use it without hitting the GitHub API.
...
# Ensure LAILABA_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Lailaba Skills Index...", flush=True)
