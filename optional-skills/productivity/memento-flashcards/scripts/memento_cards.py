...
Data file: $LAILABA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_LAILABA_HOME = Path(os.environ.get("LAILABA_HOME", Path.home() / ".lailaba"))
DATA_DIR = _LAILABA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
