...
```bash
python3 -m pyfiglet "LAILABA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=LAILABA&font=Slant" | boxes -d stone
```
