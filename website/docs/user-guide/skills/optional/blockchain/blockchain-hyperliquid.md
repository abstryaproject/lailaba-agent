...
| | |
|---|---|
| Source | Optional — install with `lailaba skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Lailaba AI |
| License | MIT |
...
The script reads `${LAILABA_HOME:-~/.lailaba}/.env` for two optional defaults:
...
Helper script: `~/.lailaba/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.lailaba/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${LAILABA_HOME:-~/.lailaba}/.env`.
...
```bash
python3 ~/.lailaba/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.lailaba/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
