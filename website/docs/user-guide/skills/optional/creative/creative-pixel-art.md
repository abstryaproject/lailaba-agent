...
| | |
|---|---|
| Source | Optional — install with `lailaba skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.lailaba/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.lailaba/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Lailaba installs package this)
