...
| | |
|---|---|
| Source | Optional — install with `lailaba skills install official/health/neuroskill-bci` |
...
Connect Lailaba to a running [NeuroSkill](https://neuroskill.com/) instance to read
