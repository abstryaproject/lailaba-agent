...
| | |
|---|---|
| Source | Optional — install with `lailaba skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Lailaba AI |
| License | MIT |
...
```
SCRIPT=~/.lailaba/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.lailaba/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
