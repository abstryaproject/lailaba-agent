...
- User wants **Lailaba itself to drive a browser** → use Lailaba' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
