...
| | |
|---|---|
| Source | Optional — install with `lailaba skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development/subagent-driven-development` |
| Version | `1.1.0` |
| Author | Lailaba AI (adapted from obra/superpowers) |
| License | MIT |
