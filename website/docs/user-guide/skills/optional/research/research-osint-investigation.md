...
| | |
|---|---|
| Source | Optional — install with `lailaba skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Lailaba AI (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $LAILABA_OSINT_CACHE/icij/ (default: ~/.cache/lailaba-osint/icij/).
...
# Set LAILABA_OSINT_UA=your-app/1.0 (your@email) to identify yourself
