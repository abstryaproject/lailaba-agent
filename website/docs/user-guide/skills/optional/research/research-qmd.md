...
| | |
|---|---|
| Source | Optional — install with `lailaba skills install official/research/qmd` |
...
Lailaba AI via the native MCP client. This is the preferred
...
Then configure Lailaba AI to connect via HTTP:
