...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Lailaba AI — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Lailaba AI! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Lailaba core? Start with [Build a Lailaba Plugin](../guides/build-a-lailaba-plugin.md)
- Building a new built-in core tool for Lailaba itself? Start with [Adding Tools](./adding-tools.md)
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.lailaba/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.lailaba` — use `get_lailaba_home()` from `lailaba_constants` for code paths and `display_lailaba_home()` for user-facing messages. See [AGENTS.md](https://github.com/NousResearch/lailaba-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/NousResearch/lailaba-agent/blob/main/LICENSE).
