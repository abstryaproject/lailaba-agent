  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Lailaba AI community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Lailaba &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Lailaba?{' '}
        <a
          href="https://github.com/NousResearch/lailaba-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
