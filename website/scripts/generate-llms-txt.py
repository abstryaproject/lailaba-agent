#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Lailaba docs site.
...
Both publish at:
  https://lailaba-agent.nousresearch.com/docs/llms.txt
  https://lailaba-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://lailaba-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Lailaba as a Python Library", None),
        ("guides/use-mcp-with-lailaba", "Use MCP with Lailaba", None),
        ("guides/use-voice-mode-with-lailaba", "Use Voice Mode with Lailaba", None),
        ("guides/use-soul-with-lailaba", "Use SOUL.md with Lailaba", None),
        ("guides/build-a-lailaba-plugin", "Build a Lailaba Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Lailaba"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "lailaba-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/lailaba-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Lailaba AI — Full Documentation\n",
        (
            "This file is the entire Lailaba AI documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Lailaba, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://lailaba-agent.nousresearch.com/docs\n",
        "Short index: https://lailaba-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
