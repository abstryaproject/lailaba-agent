  ...
  docs: [
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-lailaba-agent',
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/software-development/software-development-lailaba-agent-skill-authoring',
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/optional/devops/devops-lailaba-s6-container-supervision',
    ...
    },
    {
      ...
      items: [
        ...
        'guides/run-lailaba-with-nous-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-lailaba',
        'guides/use-soul-with-lailaba',
        'guides/use-voice-mode-with-lailaba',
        'guides/build-a-lailaba-plugin',
