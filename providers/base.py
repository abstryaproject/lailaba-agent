...
def _profile_user_agent() -> str:
    """Return a ``lailaba-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from lailaba_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"lailaba-cli/{_ver}"
    except Exception:
        return "lailaba-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # lailaba-cli UA so the catalog endpoint is reachable.
