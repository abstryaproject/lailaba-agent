...
Hooks are discovered from ~/.lailaba/hooks/ directories, each containing:
...
HOOKS_DIR = get_lailaba_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"lailaba_hook_{hook_name}"
