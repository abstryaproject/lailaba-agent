...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$LAILABA_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_lailaba_dir("platforms/whatsapp/session", "whatsapp/session")
