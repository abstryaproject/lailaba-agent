...
try:
    ...
    _LAILABA_VERSION = "0.0.0"

_APP_VERSION = _LAILABA_VERSION
_BOT_VERSION = _LAILABA_VERSION
_YUANBAO_INSTANCE_ID = str(LAILABA_INSTANCE_ID)  # single source: yuanbao_proto.LAILABA_INSTANCE_ID
