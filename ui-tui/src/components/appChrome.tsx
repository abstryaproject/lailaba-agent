import { Box, type ScrollBoxHandle, stringWidth, Text } from '@lailaba/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (LAILABA_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (LAILABA_DEV_CREDITS), lowest priority,
