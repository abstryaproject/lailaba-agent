 ...
 *
 * Symptom: in `lailaba --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@lailaba/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using lailaba --tui and as i type multiline my caret at the end will often ' +
