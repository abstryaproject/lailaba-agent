...
import type { ScrollBoxHandle } from '@lailaba/ink'
import { evictInkCaches } from '@lailaba/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.LAILABA_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
