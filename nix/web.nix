# nix/web.nix — Lailaba Web Dashboard (Vite/React) frontend build
{ pkgs, hermesNpmLib, ... }:
let
  npm = hermesNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "lailaba-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../lailaba_cli/web_dist for the
