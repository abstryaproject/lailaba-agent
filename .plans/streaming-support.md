# Streaming LLM Response Support for Lailaba AI
...
```
LAILABA_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("LAILABA_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `lailaba_cli/config.py` | 1 | +streaming config defaults |
...
LAILABA_STREAMING_ENABLED=true
```
