 ...
 *   - LAILABA AI wordmark rendered in Collapse Bold, uppercase, tracked
...
export default function Welcome() {
  return (
    <div className="lailaba-fade-in flex h-full flex-col items-center justify-center gap-10 px-12 py-10">
      ...
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>LAILABA AI</span>
          </span>
          <span aria-hidden="true">LAILABA AI</span>
        </p>
