...
/*
 * Success screen. LAILABA AI wordmark stays as the visual anchor
 ...
 * Lailaba.exe doesn't exist). We catch the Tauri error and surface it
...
export default function Success() {
  ...
  return (
    <div className="lailaba-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>Lailaba is ready</span>
          </span>
          <span aria-hidden="true">Lailaba is ready</span>
        </p>
      ...
      >
        <Rocket size={18} />
        {launching ? 'Launching…' : 'Launch Lailaba'}
      </Button>
