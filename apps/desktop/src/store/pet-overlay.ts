 ...
 * app's bounds and stays visible while Lailaba is minimized. That window carries
...
const OVERLAY_ACTIVE_KEY = 'lailaba.desktop.pet-overlay-active.v1'
const OVERLAY_BOUNDS_KEY = 'lailaba.desktop.pet-overlay-bounds.v1'
