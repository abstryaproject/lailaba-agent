...
import type { SessionInfo, UsageStats } from '@/types/lailaba'

type Updater<T> = T | ((current: T) => T)

const WORKSPACE_CWD_KEY = 'lailaba.desktop.workspace-cwd'
...
const COMPOSER_MODEL_KEY = 'lailaba.desktop.composer.model'
const COMPOSER_PROVIDER_KEY = 'lailaba.desktop.composer.provider'
const COMPOSER_EFFORT_KEY = 'lailaba.desktop.composer.reasoning-effort'
const COMPOSER_FAST_KEY = 'lailaba.desktop.composer.fast'
...
const LAST_SESSION_KEY = 'lailaba.desktop.lastSessionId'
