...
import { getProfiles, setApiRequestProfile } from '@/lailaba'
...
import type { ProfileInfo } from '@/types/lailaba'
...
// /api/profiles/active `current`). "default" is the root ~/.lailaba. This is the
...
const PROFILE_ORDER_STORAGE_KEY = 'lailaba.desktop.profileOrder'
...
const PROFILE_COLORS_STORAGE_KEY = 'lailaba.desktop.profileColors'
...
// Persist the choice and relaunch the backend under the new LAILABA_HOME. The
...
const SHOW_ALL_PROFILES_STORAGE_KEY = 'lailaba.desktop.showAllProfiles'
...
// Switch to the default (root ~/.lailaba) profile — bound to ⌘1.
