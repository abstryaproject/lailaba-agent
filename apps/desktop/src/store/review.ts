...
//
// Scope is always "uncommitted" — Lailaba' flow is agent edits you review BEFORE
...
const OPEN_KEY = 'lailaba.desktop.reviewOpen'
const COMMIT_DEFAULT_KEY = 'lailaba.desktop.reviewCommitDefault'
const TREE_MODE_KEY = 'lailaba.desktop.reviewTreeMode'
const SELECTED_KEY = 'lailaba.desktop.reviewSelectedPath'
