...
describe('assistant-ui streaming renderer', () => {
  ...
  it('renders assistant text incrementally before completion', async () => {
    ...
    expect(screen.getByRole('status', { name: 'Lailaba is loading a response' })).toBeTruthy()
    ...
    expect(screen.queryByRole('status', { name: 'Lailaba is loading a response' })).toBeNull()
