...
import type { ModelOptionProvider, ModelOptionsResponse, ModelPricing } from '@/types/lailaba'
...
export function ModelPickerDialog({
  ...
  // the `lailaba model` CLI picker, which shows the curated list verbatim.
