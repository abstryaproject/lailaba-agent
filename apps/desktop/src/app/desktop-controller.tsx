...
import { getCronJobs, getSessionMessages, listAllProfileSessions, type SessionInfo, triggerCronJob } from '../lailaba'
...
import { useHermesConfig } from './session/hooks/use-lailaba-config'
...
export function DesktopController() {
  ...
  // lailaba:// deep links (e.g. a docs "Send to App" button for an automation blueprint).
