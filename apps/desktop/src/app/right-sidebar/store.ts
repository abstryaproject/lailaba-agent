...
const TAKEOVER_KEY = 'lailaba.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Lailaba can't clear via the API — the user
 *  sees exactly what runs instead of Lailaba silently deleting their creds. */
