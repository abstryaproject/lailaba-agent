...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/lailaba'
 ...
 * log inline — the GUI equivalent of the install step `lailaba tools` runs
