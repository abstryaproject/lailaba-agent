...
import { HermesGateway } from '@/lailaba'
...
import type { RpcEvent } from '@/types/lailaba'
...
export function useGatewayBoot({
  ...
  useEffect(() => {
    ...
    // composer stayed disabled forever on "Starting Lailaba...". Once the
    ...
    const attemptReconnect = async () => {
      ...
      try {
        ...
        // "Starting Lailaba…". The probe is a no-op for a healthy or local backend.
        ...
        // as an opaque "Could not connect to Lailaba gateway". resolveGatewayWsUrl
