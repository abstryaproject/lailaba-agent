...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/lailaba'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('lailaba:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('lailaba:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Lailaba to
