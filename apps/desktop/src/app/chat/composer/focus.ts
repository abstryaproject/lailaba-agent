...
const FOCUS_EVENT = 'lailaba:composer-focus'
const INSERT_EVENT = 'lailaba:composer-insert'
const INSERT_REFS_EVENT = 'lailaba:composer-insert-refs'
const SUBMIT_EVENT = 'lailaba:composer-submit'
const VOICE_TOGGLE_EVENT = 'lailaba:composer-voice-toggle'
