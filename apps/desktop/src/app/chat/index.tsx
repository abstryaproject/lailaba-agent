...
import { getGlobalModelOptions, type HermesGateway } from '@/lailaba'
...
import type { ModelOptionsResponse } from '@/types/lailaba'
...
export function ChatView({
  ...
  const modelOptionsQuery = useQuery<ModelOptionsResponse>({
    ...
    queryFn: () => {
      ...
      if (!gateway) {
        throw new Error('Lailaba gateway unavailable')
      }
