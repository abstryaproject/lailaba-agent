...
export const en: Translations = {
  ...
  boot: {
    ready: 'Lailaba Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Lailaba settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Lailaba Desktop…'
    },
    errors: {
      backgroundExited: 'Lailaba background process exited.',
      backgroundExitedDuringStartup: 'Lailaba background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Lailaba backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update Lailaba',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Lailaba Desktop.',
    ...
    native: {
      ...
      inputBody: 'Lailaba is waiting for your response.',
      turnDoneTitle: 'Lailaba finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Lailaba defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Lailaba is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Lailaba asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Lailaba was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Lailaba follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Lailaba is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Lailaba, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Lailaba checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Lailaba configuration...',
    ...
    gateway: {
      ...
      intro:
        'Lailaba Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Lailaba backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset LAILABA_DESKTOP_REMOTE_URL and LAILABA_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Lailaba backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Lailaba backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /lailaba.',
      ...
      restartingMessage: 'Lailaba Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Lailaba ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Lailaba runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Lailaba to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Lailaba to generate pets.',
      backgroundHint: 'You can close this — Lailaba will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Lailaba desktop' },
    ...
    hermesActiveSessions: (version, count) => `Lailaba ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@lailaba:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Lailaba environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Lailaba will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'This removes the saved project from Lailaba. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Lailaba...',
    placeholderReconnecting: 'Reconnecting to Lailaba…',
    ...
    attachUrlDesc: 'Lailaba will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Lailaba to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Lailaba…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Lailaba…',
    ...
    unsupportedMessage: 'This version of Lailaba can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Lailaba from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Lailaba will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Lailaba desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Lailaba updater takes over in its own window and reopens Lailaba automatically when it’s done. Please don’t reopen Lailaba yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Lailaba reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Lailaba reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Lailaba needs a one-time install',
    ...
    settingUpTitle: 'Setting up Lailaba AI',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Lailaba CLI or desktop instance is running. Stop any running Lailaba instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Lailaba installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Lailaba AI",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Lailaba is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Lailaba…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Lailaba',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Lailaba at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Lailaba connects automatically',
      loopback: 'Opens your browser to sign in — Lailaba connects automatically',
    ...
    authorizeThere: 'Authorize Lailaba there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Lailaba there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Lailaba Desktop v${version}`,
      ...
      gatewayTitle: 'Lailaba inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Lailaba will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Lailaba is restarting...',
      askRestart: 'Ask Lailaba to restart the server',
      lookingRestart: taskId => `Lailaba is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Lailaba is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Lailaba finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Lailaba could not restart the server.',
      stillWorking:
        'Lailaba is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Lailaba is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Lailaba gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.lailaba/config.yaml). Lailaba won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Lailaba needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Lailaba needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Lailaba Desktop to use Save Image.',
    restartToSaveImages: 'Restart Lailaba Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `lailaba gateway` running?'
    }
  },
