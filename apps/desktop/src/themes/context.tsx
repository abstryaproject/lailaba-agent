...
const SKIN_KEY = 'lailaba-desktop-theme-v2'
const MODE_KEY = 'lailaba-desktop-mode-v1'
...
const PROFILE_SKINS_KEY = 'lailaba-desktop-profile-themes-v1'
const PROFILE_MODES_KEY = 'lailaba-desktop-profile-modes-v1'
// Last active profile, recorded so the boot-time paint can pick that profile's
// theme before the gateway reports which profile actually launched.
const LAST_PROFILE_KEY = 'lailaba-desktop-active-profile-v1'
...
function applyTheme(theme: DesktopTheme, mode: 'light' | 'dark') {
  ...
  try {
    window.localStorage.setItem('lailaba-boot-background', chromeBg)
    window.localStorage.setItem('lailaba-boot-color-scheme', rendered)
  } catch {
...
/** Sync the desktop skin with the active Lailaba backend theme on connect. */
