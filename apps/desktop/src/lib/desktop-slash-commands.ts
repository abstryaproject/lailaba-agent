...
/** Why a known Lailaba command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Lailaba profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show Lailaba AI version', surface: exec() },
 ...
 * Lailaba' built-in slash commands — i.e. skill commands (`/gif-search`,
