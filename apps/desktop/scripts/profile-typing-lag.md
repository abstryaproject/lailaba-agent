...
cd apps/desktop
XCURSOR_SIZE=24 LAILABA_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/lailaba-typing
# → /tmp/lailaba-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/lailaba-typing.before.heapsnapshot
# → /tmp/lailaba-typing.after.heapsnapshot
```
