...
const SIDEBAR_COLLAPSED_KEY = "lailaba-sidebar-collapsed";
          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="lailaba-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="lailaba-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({
  ...
  const { activeAction, isBusy, isRunning, pendingAction, runAction } =
    useSystemActions();
  const canUpdateHermes = status?.can_update_lailaba === true;
