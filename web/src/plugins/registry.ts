 ...
 *
 * Plugins call window.__LAILABA_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__LAILABA_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__LAILABA_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__LAILABA_PLUGIN_SDK__ = {
    ...
    // window.__LAILABA_SESSION_TOKEN__ directly.
    authedFetch,
