/**
 * Lailaba Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__LAILABA_PLUGIN_SDK__`` and
 * ``window.__LAILABA_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__LAILABA_PLUGIN_SDK__`` because:
 ...
 *   - Ship as a published ``@lailaba/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__LAILABA_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__LAILABA_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__LAILABA_PLUGIN_SDK__)
// ---------------------------------------------------------------------------
...
declare global {
  interface Window {
    __LAILABA_PLUGIN_SDK__?: HermesPluginSDK;
    __LAILABA_PLUGINS__?: PluginRegistry;
  }
}
