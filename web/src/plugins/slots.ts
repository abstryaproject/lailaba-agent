 ...
 * `window.__LAILABA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Lailaba brand in the top bar
 ...
 *  `window.__LAILABA_PLUGINS__.registerSlot(...)`.
 *
