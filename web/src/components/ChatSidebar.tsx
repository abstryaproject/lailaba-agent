...
import { api, LAILABA_BASE_PATH, buildWsAuthParam } from "@/lib/api";
...
export function ChatSidebar({
  ...
  // /api/events in lailaba_cli/web_server.py for the broadcast hop.
  //
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      ws = new WebSocket(
        `${proto}//${window.location.host}${LAILABA_BASE_PATH}/api/events?${qs.toString()}`,
      );
