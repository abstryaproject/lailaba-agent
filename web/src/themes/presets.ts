 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `lailaba_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Lailaba Teal",
  description: "Classic dark teal — the canonical Lailaba look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Lailaba look, ported from the
 ...
 * nousnet-web's <body> is white; lailaba-agent's App root is `bg-black`,
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Lailaba Teal (Large)",
  description: "Lailaba Teal with bigger fonts and roomier spacing",
