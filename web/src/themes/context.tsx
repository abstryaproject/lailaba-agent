...
const STORAGE_KEY = "lailaba-dashboard-theme";
...
const FONT_STORAGE_KEY = "lailaba-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `lailaba_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "lailaba-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-lailaba-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-lailaba-theme-font", "true");
