 ...
 *
 * Values mirror lailaba_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Lailaba default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Lailaba' default when unset). */
