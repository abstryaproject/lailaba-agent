...
Config: ~/.lailaba/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.lailaba/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_lailaba_home()`` helper (LAILABA_HOME-aware and
...
RULES_FILE = get_lailaba_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_lailaba_home() / "feishu_comment_pairing.json"
