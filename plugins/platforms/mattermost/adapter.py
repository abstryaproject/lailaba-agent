...
required — uses aiohttp which is already a Lailaba dependency.
...
def interactive_setup() -> None:
    ...
    ``lailaba_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Lailaba delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # lailaba_cli/setup.py::_setup_mattermost function.
