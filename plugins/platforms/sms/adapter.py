...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Lailaba gateway adapter.

    Each inbound phone number gets its own Lailaba session (multi-tenant).
...
# static dict in lailaba_cli/gateway.py, and the _send_sms dispatch in
