...
agent's existing :func:`~lailaba_cli.runtime_provider.resolve_runtime_provider`,
    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        if not api_key or not base_url:
            return error_response(
                error=(
                    ...
                    f"Configure {self._display} in `lailaba tools` → Image Generation."
                ),
                error_type="missing_api_key",
                provider=self._name,
                aspect_ratio=aspect_ratio,
        ...
        headers = {
            ...
            "HTTP-Referer": "https://github.com/NousResearch/lailaba-agent",
            "X-Title": "Lailaba AI",
        }
