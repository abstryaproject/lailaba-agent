# Lailaba Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.lailaba/plugins/lailaba-achievements/state.json` (existing unlock state)
  - `~/.lailaba/plugins/lailaba-achievements/scan_snapshot.json` (new)
  - `~/.lailaba/plugins/lailaba-achievements/scan_checkpoint.json` (new)
