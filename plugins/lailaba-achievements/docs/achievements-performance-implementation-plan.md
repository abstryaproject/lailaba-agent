# Lailaba Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.lailaba/plugins/lailaba-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.lailaba/plugins/lailaba-achievements/scan_checkpoint.json`.
