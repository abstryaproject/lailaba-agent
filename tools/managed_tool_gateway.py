...
def auth_json_path():
    """Return the Lailaba auth store path, respecting LAILABA_HOME overrides."""
    return get_lailaba_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`lailaba tools`, banner/status paint, provider
