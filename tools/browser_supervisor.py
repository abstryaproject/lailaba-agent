...
One ``CDPSupervisor`` runs per Lailaba ``task_id`` that has a reachable CDP
...
DIALOG_BRIDGE_HOST = "lailaba-dialog-bridge.invalid"
...
(() => {
  ...
  const ENDPOINT = "http://lailaba-dialog-bridge.invalid/";
