...
Trust levels:
  - builtin:   Ships with Lailaba. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.lailaba/\.env|\~/\.lailaba/\.env',
     "lailaba_env_access", "critical", "exfiltration",
     "directly references Lailaba secrets file"),
    ...
    (r'\.lailaba/config\.yaml|\.lailaba/SOUL\.md',
     "lailaba_config_mod", "critical", "persistence",
     "references Lailaba configuration files directly"),
...
# scan. `.skillignore` is the Lailaba-native name; `.clawhubignore` is honored
