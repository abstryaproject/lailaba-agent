...
Invoked by ``lailaba kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Lailaba AI board.
...
def _profile_author() -> str:
    """Mirror of ``lailaba_cli.kanban._profile_author``."""
    return (
