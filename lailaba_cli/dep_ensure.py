...
def _has_lailaba_agent_browser() -> bool:
    ...
    # install.sh installs globally into $LAILABA_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-HermesHome", str(get_lailaba_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = lailaba_subprocess_env(inherit_credentials=False)
