...
Used by ``lailaba profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``lailaba_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Lailaba AI kanban board.
...
Rules:
  ...
  - Never write "Lailaba AI profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_lailaba_home())
        else:
