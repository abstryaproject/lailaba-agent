"""``lailaba tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'lailaba tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # lailaba tools list [--platform cli]
    ...
    # lailaba tools disable <name...> [--platform cli]
    ...
    # lailaba tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `lailaba tools` runs after you pick a provider that\n"
