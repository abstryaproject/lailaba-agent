"""
Lailaba CLI - Unified command-line interface for Lailaba AI.

Provides subcommands for:
- lailaba chat          - Interactive chat (same as ./lailaba)
- lailaba gateway       - Run gateway in foreground
- lailaba gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `lailaba setup` on a fresh Pi.
    ...
    lailaba_cli/stdio.py::configure_windows_stdio() runs later from the entry
