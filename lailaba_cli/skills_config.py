"""
Skills configuration for Lailaba AI.
`lailaba skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.lailaba/config.yaml under:
...
from lailaba_cli.config import cfg_get, load_config, save_config
from lailaba_cli.colors import Colors, color
from lailaba_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `lailaba skills`."""
    from lailaba_cli.curses_ui import curses_checklist
