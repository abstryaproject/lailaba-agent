...
Entry point: ``lailaba whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``lailaba_cli/main.py``).
...
Lailaba gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Lailaba to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Lailaba needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Lailaba gateway in another terminal:")
    print("         lailaba gateway")
    print()
    ...
    print()
    print("  Docs: https://lailaba-agent.nousresearch.com/docs/user-guide/")
