---
name: lailaba-agent-skill-authoring
...
2. **Choose the right context load.** A model-invoked Lailaba skill pays for its description every turn. Keep descriptions focused on trigger classes and the skill's distinctive behavior. Put details in the body or linked references.
