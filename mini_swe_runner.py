#!/usr/bin/env python3
"""
SWE Runner with Lailaba Trajectory Format

A runner that uses Lailaba-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Lailaba-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Lailaba-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Lailaba format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Lailaba-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Lailaba-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Lailaba Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Lailaba-Agent's built-in execution environments
    and outputs trajectories in Lailaba-Agent format.
    """
    ...
    def _convert_to_lailaba_format(
        self,
        ...
        """
        Convert internal message format to Lailaba trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Lailaba trajectory format
        trajectory = self._convert_to_lailaba_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Lailaba trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Lailaba Trajectory Format")
    print("=" * 60)
