...
Browser automation is optional. The installer should not leave Lailaba
...
def test_install_script_does_not_autodetect_system_browser_on_path() -> None:
    ...
    assert "Skipping Playwright browser download; Lailaba will use the system browser." not in text
