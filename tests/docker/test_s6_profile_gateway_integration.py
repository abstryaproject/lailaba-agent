...
The unit tests in tests/lailaba_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned lailaba-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/lailaba")
from lailaba_cli.service_manager import S6ServiceManager
