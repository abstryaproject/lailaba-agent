"""Tests for CodexEventProjector — codex item/* events → Lailaba messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Lailaba' message alternation invariant."""
