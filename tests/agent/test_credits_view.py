...
from lailaba_cli.nous_account import NousPortalAccountInfo, NousPaidServiceAccessInfo
...
def test_view_fetch_failure_is_logged_out(monkeypatch):
    ...
    monkeypatch.setattr("lailaba_cli.nous_account.get_nous_portal_account_info", _boom)
...
def test_credits_command_registered():
    from lailaba_cli.commands import resolve_command, COMMAND_REGISTRY
