"""Tests for _setup_feishu() in lailaba_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("lailaba_cli.config.save_env_value", side_effect=mock_save), \
         patch("lailaba_cli.config.get_env_value", side_effect=mock_get), \
         patch("lailaba_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("lailaba_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("lailaba_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("lailaba_cli.cli_output.print_header"), \
         patch("lailaba_cli.cli_output.print_info"), \
         patch("lailaba_cli.cli_output.print_success"), \
         patch("lailaba_cli.cli_output.print_warning"), \
         patch("lailaba_cli.cli_output.print_error"), \
