...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("LAILABA_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("LAILABA_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("LAILABA_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
