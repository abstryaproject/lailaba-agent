...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.lailaba/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at lailaba_state import time, before pytest's LAILABA_HOME monkeypatch
    fires — the autouse fixture's LAILABA_HOME override doesn't help here.)
    """
