"""Tests for the specifier module + `lailaba kanban specify` CLI surface.
...
from lailaba_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `lailaba kanban …` argparse surface directly."""
