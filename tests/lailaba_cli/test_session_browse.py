"""Tests for the interactive session browser (`lailaba sessions browse`).
...
from lailaba_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """lailaba sessions browse should be parseable."""
