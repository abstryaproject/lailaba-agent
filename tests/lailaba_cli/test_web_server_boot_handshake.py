...
Simulates a slow lailaba_cli.gateway import (15-30 s on a fresh Windows install
...
1. _lifespan fire-and-forget: patched _warm_gateway_module sleeps N seconds in
   ...
   blocked, LAILABA_DASHBOARD_READY would fire immediately).
...
import lailaba_cli.web_server as web_server_mod
...
def test_lifespan_warmup_is_nonblocking():
    ...
    LAILABA_DASHBOARD_READY would have fired without delay.
    """
