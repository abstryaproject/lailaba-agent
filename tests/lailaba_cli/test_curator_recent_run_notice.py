...
The notice prints the most recent curator run summary on `lailaba update`,
...
session start) so users normally never see the rename map. `lailaba update`
