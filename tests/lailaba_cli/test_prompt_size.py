"""Tests for the ``lailaba prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from lailaba_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(lailaba_home, memory_text="", user_text=""):
    mem_dir = lailaba_home / "memories"
...
def _seed_skill(lailaba_home, name, description):
    skill_dir = lailaba_home / "skills" / "demo" / name
