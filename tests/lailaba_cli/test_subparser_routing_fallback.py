...
The main() function in lailaba_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `lailaba -c model`
...
def _build_parser():
    """Build a minimal replica of the lailaba top-level parser."""
