...
def _parse_slack_args(argv):
    """Build the real `lailaba slack` parser and parse argv against it."""
...
class TestSlackFullManifest:
    """Generated full Slack app manifest used by `lailaba slack manifest`."""

    def test_app_home_messages_are_writable(self):
        manifest = _build_full_manifest("Lailaba", "Your Lailaba agent on Slack")
    ...
    def test_no_assistant_omits_assistant_pieces(self):
        manifest = _build_full_manifest(
            "Lailaba", "Your Lailaba agent on Slack", include_assistant=False
        )
