...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from lailaba_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in LAILABA_OVERLAYS
        overlay = LAILABA_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify lailaba doctor recognizes Xiaomi env vars."""
