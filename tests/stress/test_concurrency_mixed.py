...
def worker_loop(worker_id: int, lailaba_home: str, result_file: str) -> None:
...
def reclaimer_loop(lailaba_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="lailaba_mixed_stress_")
    print(f"LAILABA_HOME = {home}")
