...
projection into Lailaba' display, approval bridging, transcript projection into
...
"codex_app_server"`. Lailaba' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("LAILABA_KANBAN_TASK"):
            kanban_db = spawn_env.get("LAILABA_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "LAILABA_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("LAILABA_HOME", os.path.expanduser("~/.lailaba")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "lailaba",
        client_title: str = "Lailaba AI",
