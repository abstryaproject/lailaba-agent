...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Lailaba's web-provider config and
        ...
        # native search engine for xAI sessions instead of Lailaba's
        # configured web provider (Tavily/etc.), and those results bypass
        # Lailaba's tool-trace / citation plumbing (they arrive baked into the
