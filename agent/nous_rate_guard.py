...
(3 SDK retries x 3 Lailaba retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_lailaba_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".lailaba")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Lailaba, ...) behind one endpoint.  A 429 can mean either:
